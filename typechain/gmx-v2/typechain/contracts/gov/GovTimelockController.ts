...
export interface GovTimelockControllerInterface extends utils.Interface {
  functions: {
...
export interface GovTimelockController extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovTimelockControllerInterface;
