...
export interface ProtocolGovernorInterface extends utils.Interface {
  functions: {
...
export interface ProtocolGovernor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProtocolGovernorInterface;
