...
export interface WithdrawalStoreUtilsInterface extends utils.Interface {
  functions: {
...
export interface WithdrawalStoreUtils extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WithdrawalStoreUtilsInterface;
