...
export interface ReaderWithdrawalUtilsInterface extends utils.Interface {
  functions: {
    "getWithdrawalAmountOut(DataStore,(address,address,address,address),((uint256,uint256),(uint256,uint256),(uint256,uint256)),uint256,address,uint8)": FunctionFragment;
  };
