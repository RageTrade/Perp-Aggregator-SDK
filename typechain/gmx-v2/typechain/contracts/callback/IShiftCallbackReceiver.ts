...
export interface IShiftCallbackReceiverInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "afterShiftCancellation" | "afterShiftExecution"
  ): FunctionFragment;
...
export interface IShiftCallbackReceiver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IShiftCallbackReceiverInterface;
