...
export interface TimelockInterface extends utils.Interface {
  functions: {
    ...
    "setAtomicOracleProviderAfterSignal(address,bool)": FunctionFragment;
    "setDataStreamAfterSignal(address,bytes32,uint256)": FunctionFragment;
    "setFeeReceiverAfterSignal(address)": FunctionFragment;
    "setOracleProviderEnabled(address,bool)": FunctionFragment;
    "setOracleProviderEnabledAfterSignal(address,bool)": FunctionFragment;
    ...
    "signalSetDataStream(address,bytes32,uint256)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "setDataStreamAfterSignal"
      | "setFeeReceiverAfterSignal"
      | "setOracleProviderEnabled"
      | "setOracleProviderEnabledAfterSignal"
  ...
  encodeFunctionData(
    functionFragment: "setAtomicOracleProviderAfterSignal",
    values: [PromiseOrValue<string>, PromiseOrValue<boolean>]
  ): string;
  encodeFunctionData(
    functionFragment: "setDataStreamAfterSignal",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "setOracleProviderEnabled",
    values: [PromiseOrValue<string>, PromiseOrValue<boolean>]
  ): string;
  encodeFunctionData(
    functionFragment: "setOracleProviderEnabledAfterSignal",
    values: [PromiseOrValue<string>, PromiseOrValue<boolean>]
  ): string;
  encodeFunctionData(
