...
export interface PrecisionInterface extends utils.Interface {
  functions: {
    ...
    "FLOAT_PRECISION_SQRT()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "FLOAT_PRECISION_SQRT",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Precision extends BaseContract {
  ...
  functions: {
    ...
    FLOAT_PRECISION_SQRT(overrides?: CallOverrides): Promise<[BigNumber]>;
