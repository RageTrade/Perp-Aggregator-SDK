...
export interface IExternalHandlerInterface extends utils.Interface {
  functions: {
...
export interface IExternalHandler extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IExternalHandlerInterface;
